    ...
    <div class="content-block">
      <div class="dx-card responsive-paddings back-colored">
        ...
        <div class="content-header">
          <dx-toolbar class="back-colored">
            <dx-item location="before">
              <div class="content-title">출고요청현황</div>
            </dx-item>
          </dx-toolbar>
        </div>
        ...
        <div>
          <div class="search-status">
            <span class="search-title">출고요청일자</span>
            ...
            <span class="search-tab"></span>
            <dx-check-box text="미출고" v-model:value="vars.formData.notReleased" />
      ...
      <div class="dx-card responsive-paddings mt-1">
        ...
        >
          ...
          <dx-column caption="출고요청수량" data-field="release_request_number" data-type="number" format="fixedPoint" />
          ...
          <dx-column caption="출고번호" data-field="reelase_number" />
...
export default {
  ...
  setup() {
    ...
    const methods = {
      ...
      async searchToday() {
        vars.formData.startDate = new Date();
        vars.formData.endDate = new Date();
      },
      async searchYesterday() {
        const today = new Date();
        vars.formData.startDate = new Date(today.getFullYear(), today.getMonth(), today.getDate() - 1);
        vars.formData.endDate = new Date(today.getFullYear(), today.getMonth(), today.getDate() - 1);
      },
      async searchCurrentMonth() {
        const today = new Date();
        vars.formData.startDate = new Date(today.getFullYear(), today.getMonth(), 1);
        vars.formData.endDate = new Date();
      },
      async searchPreviousMonth() {
        const today = new Date();
        vars.formData.startDate = new Date(today.getFullYear(), today.getMonth() - 1, 1);
        vars.formData.endDate = new Date(today.getFullYear(), today.getMonth(), 0);
      },
