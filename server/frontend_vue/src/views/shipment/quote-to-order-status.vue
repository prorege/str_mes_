    ...
    <div class="content-block">
      <div class="dx-card responsive-paddings back-colored">
        ...
        <div class="content-header">
          <dx-toolbar class="back-colored">
            <dx-item location="before">
              <div class="content-title">견적·수주 현황</div>
            </dx-item>
          </dx-toolbar>
        </div>
        ...
        <div>
          <div class="search-status">
            ...
            <dx-check-box text="미수주유무" v-model:value="vars.formData.notOrdered" />
      ...
      <div class="dx-card responsive-paddings mt-1">
        ...
        >          
          ...
          <template #masterDetailTemplate="{ data: quote }">
            <quote-to-order-detail :template-data="quote" />
          </template>
        </dx-data-grid>
      </div>
    </div>
...
import QuoteToOrderDetail from './quote-to-order-detail.vue';
  ...
  setup() {
    ...
    const methods = {
      onGridInitialized(evt, key) {
        ...
        stateStore.bind(`shipment-quote-order-${key}`, evt.component);
      ...
      goQuote(e) {
        router.push({ path: `/shipment/quote/${e.data.order.id}` });
      },
      ...
      async onExporting (evt) {
        shipmentQuoteItem.exportData(evt.component, '견적수주현황', `견적수주현황_${Date.now()}.xlsx`)
        evt.cancel = true
      }
    };
