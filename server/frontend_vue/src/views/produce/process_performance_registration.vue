...
async function onFormDataChange (evt) {
  ...
  switch (evt.dataField) {
    ...
    case 'performance.work_rest_time': {
      ...
      const start = moment(formData.value.performance.work_start_time, 'HH:mm').startOf('minute');
      const end = moment(formData.value.performance.work_end_time, 'HH:mm').startOf('minute');
  ...
  <div class="mobile-container back-colored">
    ...
    <div class="display-flex">
      ...
      <div class="consume-table">
        ...
        <dx-data-grid
          ...
          <dx-column caption="자재LOT번호" cssClass="consume-column" data-field="lot_number" :allow-editing="false" />
          <dx-column caption="품목코드" cssClass="consume-column" data-field="item_code" :allow-editing="false" />
          <dx-column caption="투입수량" cssClass="consume-column" data-field="quantity" :allow-editing="false" />
          <dx-column caption="생성시간" cssClass="consume-column" data-field="created" :visible="false" :allow-editing="false" />
          <dx-column caption="생산실적번호" cssClass="consume-column" data-field="process_number" :visible="false" :allow-editing="false" :show-in-column-chooser="false" />
    ...
    <dx-popup
      ...
      <template #popup-content>
        ...
        >
          <dx-column caption="작업지시번호" cssClass="popup-column"  data-field="work_order.number" :filter-operations="['contains', '=']" />
          <dx-column caption="일자" cssClass="popup-column"  data-field="work_order.target_date" data-type="date" format="yyyy-MM-dd" :sort-index="0" sort-order="desc" />
          <dx-column caption="고객업체" cssClass="popup-column" data-field="client_company" />
          <dx-column caption="수주번호" cssClass="popup-column"  data-field="order_number" />
          <dx-column caption="수주일자" cssClass="popup-column"  data-field="order.order_date" />
          <dx-column caption="담당자" cssClass="popup-column"  data-field="work_order.manager" />
          <dx-column caption="품목코드" cssClass="popup-column"  data-field="item_code" />
          <dx-column caption="품명" cssClass="popup-column"  data-field="item.item_name" />
          <dx-column caption="규격" cssClass="popup-column"  data-field="item.item_standard" />
          <dx-column caption="작업지시수량" cssClass="popup-column"  data-field="required_quantity" />
          <dx-column caption="단가" cssClass="popup-column"  data-field="unit_price" :format="{ type: 'fixedPoint', precision: 2 }" />
          <dx-column caption="단위" cssClass="popup-column"  data-field="unit" />
          <dx-column caption="공급가" cssClass="popup-column"  data-field="supply_price" :format="{ type: 'fixedPoint', precision: 2 }" />
          <dx-column caption="요청납기" cssClass="popup-column"  data-field="request_delivery_date" data-type="date" format="yyyy-MM-dd" />
          <dx-column caption="미입고수량" cssClass="popup-column"  data-field="unproduced_quantity" />
          <dx-column caption="가용재고" cssClass="popup-column"  data-field="available_stock" />
          <dx-column caption="현재고" cssClass="popup-column"  data-field="current_stock" />
          <dx-column caption="품목대분류" cssClass="popup-column"  data-field="item.main_category" />
          <dx-column caption="품목중분류" cssClass="popup-column"  data-field="item.middle_category" />
          <dx-column caption="품목소분류" cssClass="popup-column"  data-field="item.sub_category" />
          <dx-column caption="자산구분" cssClass="popup-column"  data-field="item.asset_type" />
          <dx-column caption="안전재고" cssClass="popup-column"  data-field="item.safety_stock" />
          <dx-column caption="종료" cssClass="popup-column"  data-field="end_yn" data-type="boolean" />
        ...
        <dx-data-grid
          ...
          @selection-changed="onSelectionChanged"
        >
          <dx-column caption="실적번호" cssClass="popup-column" data-field="number" />
          <dx-column caption="생성시간" cssClass="popup-column" data-field="created" width="0px"  :sort-index="0" sort-order="desc" />
          <dx-column caption="공정명" cssClass="popup-column" data-field="process.process_name" />
          <dx-column caption="작지번호" cssClass="popup-column" data-field="order_number" />
          <dx-column caption="완료수량" cssClass="popup-column" data-field="process_quantity" />
          <dx-column caption="품목코드" cssClass="popup-column" data-field="item_code" />
          <dx-column caption="품명" cssClass="popup-column" data-field="item.item_name" />
          <dx-column caption="작지수량" cssClass="popup-column" data-field="work_order_item.required_quantity" data-type="number" />
      ...
      <template #popup-content>
        <div class="numpad">
          ...
          <div class="numpad-body">
            ...
            <div class="numpad-item" @click="addNumpad(-1)">한개지움</div>
            <div class="numpad-item" @click="addNumpad('0')">0</div>
            <div class="numpad-item" @click="addNumpad(null)">모두지움</div>
          </div>
        </div>
      </template>
      <dx-toolbar-item location="after" widget="dxButton" :options="{icon: 'close', text: '닫기', onClick: closeNumpad}" />
      <dx-toolbar-item location="after" widget="dxButton" :options="{icon: 'print', text: '확인', onClick: submitNumpad}" />
    </dx-popup>
  </div>
</template>

<style lang="scss" scoped>
::v-deep .dx-datagrid-nodata{
  font-size: 1.7em !important;
}
::v-deep .dx-placeholder{
  font-size: 1.5em !important;
}
::v-deep .dx-toolbar .dx-toolbar-items-container{
  height: 55px;
}
...
::v-deep .dx-field-item-label-content{
  width: auto !important;
}

::v-deep .reg-form-input {
