...
<div>
    ...
    <div class="dx-card responsive-paddings back-colored">
        ...
        <dx-toolbar class="back-colored">
            ...
            <div class="content-title">매입원장</div>
            </dx-item>
        </dx-toolbar>
        </div>
    ...
    <div class="dx-card responsive-paddings mt-1">
        ...
        <template #export>
        <dx-button text="매입원장출력" icon="export" @click="printProductReceipt" />
        <dx-button text="Excel" icon="xlsxfile" @click="savePurchaseBalanceItem" />
        </template>
...
const params = {}
    ...
    filter: [
        ...
        ['receiving.client_company', '=', formData.clientName]
    ],
    sort: [
    ...
    filter: [
        ...
        ['receiving_return.client_company', '=', formData.clientName]
    ],
    sort: [
    ...
    filter: [
        ...
        ['payment.client_company', '=', formData.clientName]
    ],
    sort: [
