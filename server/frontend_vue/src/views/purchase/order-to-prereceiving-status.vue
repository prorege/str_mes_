    ...
    <div class="content-block">
      <div class="dx-card responsive-paddings back-colored">
        ...
        <div class="content-header">
          <dx-toolbar class="back-colored">
            <dx-item location="before">
              <div class="content-title">발주·가입고 현황</div>
            </dx-item>
          </dx-toolbar>
        </div>
        ...
        <div>
          <div class="search-status">
            ...
            <span class="search-tab"></span>
            <dx-check-box text="미가입고유무" v-model:value="vars.formData.notShipped" />
      ...
      <div class="dx-card responsive-paddings mt-1">
        ...
        >          
          ...
          <dx-column caption="확정납기" data-field="fixed_delivery_date" data-type="date" format="yyyy-MM-dd" />
          ...
          <template #masterDetailTemplate="{ data: order }">
            <order-to-prereceiving-detail :template-data="order" />
          </template>
        </dx-data-grid>
      </div>
    </div>
...
import OrderToPrereceivingDetail from './order-to-prereceiving-detail.vue';
  ...
  setup() {
    ...
    const methods = {
      onGridInitialized(evt, key) {
        ...
        stateStore.bind(`purchase-order-prereceiving-${key}`, evt.component);
      ...
      async onExporting (evt) {
        purchaseOrderItem.exportData(evt.component, '발주가입고현황', `발주가입고현황_${Date.now()}.xlsx`)
        evt.cancel = true
      }
    };
