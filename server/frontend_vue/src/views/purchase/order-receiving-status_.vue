    ...
    <div class="content-block">
        ...
        <div class="content-header">
          <dx-toolbar class="back-colored">
            <dx-item location="before">
              <div class="content-title">발주계획·발주 현황</div>
            </dx-item>
          </dx-toolbar>
        </div>
      ...
      <div class="dx-card responsive-paddings mt-1">
        ...
        >
          ...
          <dx-column caption="미가입고수량" data-field="not_shipped" data-type="number" format="fixedPoint" />
          <dx-column caption="입고수량"  data-field="receiving_quantity" data-type="number" format="fixedPoint" :allow-sorting="false"/>
          <dx-column caption="미입고수량" data-type="number" format="fixedPoint" :allow-sorting="false" :calculate-display-value="methods.calculateNotReceivingQuantity" />
