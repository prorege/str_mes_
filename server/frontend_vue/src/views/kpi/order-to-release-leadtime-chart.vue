      ...
      <div class="content-header">
        <dx-toolbar>
          <dx-item location="before">
            <div class="content-title">수주-출하리드타임</div>
          </dx-item>
        </dx-toolbar>
      </div>
    ...
    <div class="graph-container dx-card responsive-paddings">
      <div class="graph-item">
        ...
        <dx-chart :data-source="ds.series1.value" class="graph-wrap">
          <dx-common-series-settings type="bar" :bar-width="50" argument-field="key" :show-in-legend="false">
        ...
        <label>월</label>
        <div class="avg_box" v-if="ds.visible.value">평균 32.5일</div>
      </div>
    </div>
