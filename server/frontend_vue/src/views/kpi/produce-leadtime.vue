  ...
  <div>
    <div class="content-block">
        ...
        <div class="content-header">
          <dx-toolbar class="back-colored">
            <dx-item location="before">
              <div class="content-title">제조 리드타임</div>
            </dx-item>
          </dx-toolbar>
        </div>
        <div>
          <div class="search-status">
            <span class="search-title">작지일자</span>
      ...
      <div class="dx-card responsive-paddings mt-1">
        ...
        >
          <dx-column caption="작지번호" data-field="order_number" />
          <dx-column caption="작지일자" data-field="order_date" data-type="date" format="yyyy-MM-dd" />
          <dx-column caption="고객업체" data-field="client_company" />
          <dx-column caption="생산입고번호" data-field="produce_number" />
          <dx-column caption="생산입고일자" data-field="produce_date" data-type="date" format="yyyy-MM-dd" />
...
export default {
  ...
  setup() {
    ...
    const api = new ApiService('/api/mes/v1/kpi/produce/leadtime');
    const vars = {};
    vars.grid = {};
    ...
    const methods = {
      onGridInitialized(evt, key) {
        ...
        stateStore.bind(`produce-leadtime-${key}`, evt.component);
      },
      async loadItem() {
        const params = {
