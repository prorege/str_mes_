    ...
    >
        ...
        <template #popup-content>
            <dx-scroll-view width="100%" height="100%">
                ...
                <div v-if="vars.init" class="auto-commencement-report">
                                ...
                                <div class="content-body-container">    
                                    <div class="body-1">
                                        ...
                                        <div class="report-style-A-content-box">    
                                            ...
                                            <span>:</span>
                                            <span class="report-style-A-content-box-content">{{ vars.formData.project_management.project_name }} 관련 착수계 제출의 건 </span>
                                        </div>
                                    ...
                                    <div class="body-2" >
                                        ...
                                        <div style="margin-bottom: 10px;">
                                            <div>
                                                <span>2.&nbsp;</span>
                                                <span>우수조달공동상표 물품으로 계약 체결한 "{{ vars.formData.project_management.project_name }}" 건과 관련하여 아래와 같이 납품완료계 및 관련 서류를 제출합니다.
                                                </span>
                                            </div>
                                            <div style="width: 100%; padding: 10px; display: flex; flex-direction: column; gap: 8px;">
                                                ...
                                                <div style="width: 100%;" class="report-style-A-content-box">
                                                    <div>마.</div>
                                                    <div class="report-style-A-content-box-title width-75">
                                                        <span style="letter-spacing: 2px;" >납품</span>
                                                        <span style="letter-spacing: 2px;" >기한</span>
                                                    </div>
                                                    <span>:</span>
                                            ...
                                            <div style="width: 100%; display: flex; padding: 10px;"> 
                                                <table style="table-layout: fixed; border-collapse: separate; border-spacing: 0 8px;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>3.&nbsp;&nbsp;배정업체 등록서류 1부</td>
                                                        </tr>
                                                        <tr>
                                                            <td>4.&nbsp;&nbsp;고용산재가입증명원 1부</td>
                                                        </tr>
                                                        <tr>
                                                            <td>5.&nbsp;&nbsp;현장대리인계 1부</td>
                                                        </tr>
    ...
    setup(props, { emit }) {
        ...
        const methods = {
            ...
            async printReport() {
                ...
                await printReport(DOCUMNET, completionData, document.querySelector('.auto-commencement-report'));
