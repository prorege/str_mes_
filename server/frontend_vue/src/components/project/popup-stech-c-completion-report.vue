                                    ...
                                    <div class="body-1" style="border-bottom: 2px solid #000;">
                                        <div>
                                            ...
                                            <div class="report-style-A-content-box">    
                                                ...
                                                <span>:</span>
                                                <span class="report-style-A-content-box-content">{{ vars.formData.project_management.project_name }} 관련 준공계 제출 </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="body-2">
    ...
    setup(props, { emit }) {
        ...
        const methods = {
            ...
            async printReport() {
                ...
                await printReport(DOCUMNET, completionData, document.querySelector('.stech-c-report'));
