                                ...
                                <div class="body-2">
                                    ...
                                    <div>
                                        <div style="display: flex; flex-direction: column; gap: 10px; margin-bottom: 10px;">
                                            <div>2. {{ methods.contractData() }} &nbsp;용역으로 계약 체결한
                                            </div>
                                            <div style="margin-left: 10px;">
                                                "{{ vars.formData.project_management.project_name }}" 
                                            </div>
                                            <div style="margin-left: 10px;">
                                                건과 관련하여 아래와 같이 완료 서류를 제출드립니다.
                                            </div>
                                        </div>
                                ...
                                <div class="body-1">
                                    ...
                                    <div>
                                        ...
                                        <div class="report-style-A-content-box">
                                            ...
                                            <span v-else class="report-style-A-content-box-content">:</span>
                                            <span class="report-style-A-content-box-content">{{ vars.formData.attr01 }} </span>
                                        </div>
                                        <div class="report-style-A-content-box">    
                                            <span class="report-style-A-content-box-title width-78">
                                                <span>제</span>
                                            ...
                                            <span>:</span>
                                            <span class="report-style-A-content-box-content">{{ vars.formData.project_management.project_name }} 관련 완료계 제출의 건 </span>
                                        </div>
                                    </div>
                                </div>
                                <div class="body-2">
                                    ...
                                    <div>
                                        <div>
                                            ...
                                            <span v-if="!vars.formState.readOnly">
                                                ...
                                                ({{ methods.contractData() }}) &nbsp; 용역으로 계약 체결한 "{{ vars.formData.project_management.project_name }}" 건과 관련하여 아래와 같이 완료계 및 관련 서류를 제출합니다.
                                            </span>
                                            <span v-else>
                                        ...
                                        <div style="width: 100%; padding: 10px; display: flex; flex-direction: column; gap: 8px;">
                                            <div style="width: 100%;" class="report-style-A-content-box">
                                                <div>가.</div>
                                                <div class="report-style-A-content-box-title width-65">
                                                    <span>계약</span>
                                                    <span>건명</span>
                                                </div>
                                                <span>:</span>
    ...
    setup(props, { emit }) {
        ...
        const methods = {
            ...
            async printReport() {
                ...
                await printReport(DOCUMNET, completionData, document.querySelector('.measurement-report'));
