<template>
  ...
  >
    <dx-column caption="생산입고번호" data-field="number" :sort-index="1" sort-order="desc" />
    <dx-column caption="생산일자" data-field="target_date" data-type="date" format="yyyy-MM-dd" :sort-index="0" sort-order="desc" />
