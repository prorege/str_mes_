<template>
  ...
  >
    <dx-column caption="실적번호" data-field="number" />
    <dx-column caption="생성시간" data-field="created" width="0px" />
    <dx-column caption="공정명" data-field="process.process_name" />
    <dx-column caption="작지번호" data-field="order_number" />
    <dx-column caption="완료수량" data-field="process_quantity" />
    <dx-column caption="품목코드" data-field="item_code" />
    <dx-column caption="품명" data-field="item.item_name" />
    <dx-column caption="작지수량" data-field="work_order_item.required_quantity" data-type="number" />
