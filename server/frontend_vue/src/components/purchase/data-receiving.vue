<template>
  ...
  >
    <dx-column caption="입고번호" data-field="receiving_number" min-width="150" :sort-index="1" sort-order="desc" />
    <dx-column caption="입고일자" data-field="receiving_date" data-type="date" format="yyyy-MM-dd" :sort-index="0" sort-order="desc" />
...
import { purchaseReceiving } from '@/data-source/purchase';
