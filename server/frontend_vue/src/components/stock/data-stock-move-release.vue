<template>
  ...
  >
    <dx-column caption="이동출고번호" data-field="number" :sort-index="1" sort-order="desc" />
    <dx-column caption="요청 일자" data-field="target_date" data-type="date" format="yyyy-MM-dd" :sort-index="0" sort-order="desc" />
...
import { stockMoveRelease } from '../../data-source/stock';
