                ...
                <td colspan="8" style="padding:0">
                  <table>
                    ...
                    <tr>
                      ...
                      <td>매입합계: <%= numeral(month.monthSumPrice).format('0,0') %></td>
                      <td>세액합계: <%= numeral(month.monthSumVat).format('0,0') %></td>
                      <td>결재합계: <%= numeral(month.monthSumPay).format('0,0') %></td>
                    </tr>
                    <tr>
                      <td>수량누계: <%= numeral(month.accSumQty).format('0,0') %></td>
                      <td>매입누계: <%= numeral(month.accSumPrice).format('0,0') %></td>
                      <td>세액누계: <%= numeral(month.accSumVat).format('0,0') %></td>
                      <td>결재누계: <%= numeral(month.accSumPay).format('0,0') %></td>
                    </tr>
                  </table>
                </td>
              </tr>
